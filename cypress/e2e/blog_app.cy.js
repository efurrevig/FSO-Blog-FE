        ...
        describe('When blogs exist', function () {
            ...
            it.only('blogs are sorted desc by likes', function () {
                ...
                cy.get('@blogs')
                    .get('.blog')
                    .eq(0)
                    .should('contain', 'Cypress one')
                    .as('blog1')
                cy.get('@blogs')
                    .get('.blog')
                    .eq(1)
                    .should('contain', 'Cypress two')
                    .as('blog2')
                cy.get('@blogs')
                    .get('.blog')
                    .eq(2)
                    .should('contain', 'Cypress three')
                    .as('blog3')
                ...
                it('A blog can be liked', function () {
                    ...
                    cy.get('@blog')
                        ...
                        .should(($likeCount) => {
                            ...
                            expect(
                                parseInt(updatedLikeCount)
                            ).to.be.greaterThan(parseInt(this.initialLikeCount))
                        })
                })
